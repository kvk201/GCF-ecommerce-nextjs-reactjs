                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-4">
                                <div className="copy-right">
                                    <p>Copyright &copy; {currentYear} Greener Coin Finance. <br/>All Rights Reserved</p>
                                </div>
                            </div>
                            ...
                            <div className="col-lg-3">
                                <div className="designed">
                                    <p>
                                        Designed By <i className='bx bx-heart'></i> <a href="https://www.linkedin.com/in/kumar618/" target="_blank">Vivek Kumar</a>
                                    </p>
                                </div>
                            </div>
                        </div>
